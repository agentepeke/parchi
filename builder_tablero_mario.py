...
class Builder_tablero_mario(Builder):
    ...
    def pintar_tablero(self, Panel):
        ...
        Fi_mario = PhotoImage(file="img_mario\mario.gif")
        Fi_luigi = PhotoImage(file="img_mario\luigui.gif")
        Fi_yoshi = PhotoImage(file="img_mario\yoshicara1.gif")
        Fi_bowser = PhotoImage(file="img_mario\\toad.gif")

        Ficha.imgFichas["rojo"] = Fi_mario
        Ficha.imgFichas["verde"] = Fi_luigi
        Ficha.imgFichas["amarillo"] = Fi_yoshi
        Ficha.imgFichas["azul"] = Fi_bowser
        ...
        fondo1 = ImageTk.Image.open("img_mario\\fondo_mario.gif")
        fondo1 = fondo1.resize((self.Panel.winfo_screenwidth(), self.Panel.winfo_screenheight()))
        fondo1 = ImageTk.PhotoImage(fondo1)

        LF = Label(self.Panel, image=fondo1)
        ...
        tablero1 = Tablero_Mario.crearTablero(TABLEROM, self.LABEL_TABLEO)
