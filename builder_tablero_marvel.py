...
from tablero_marvel import Tablero_Marvel


class Builder_tablero_marvel(Builder):
    ...
    def pintar_tablero(self, Panel):
        ...
        Fi_iron = PhotoImage(file="img_marvel\\iron_man.gif")
        Fi_hulk = PhotoImage(file="img_marvel\\hulkjpg.gif")
        Fi_spider = PhotoImage(file="img_marvel\\spiderman.gif")
        Fi_cap = PhotoImage(file="img_marvel\\CP.gif")

        Ficha.imgFichas["rojo"] = Fi_iron
        Ficha.imgFichas["verde"] = Fi_hulk
        Ficha.imgFichas["amarillo"] = Fi_spider
        Ficha.imgFichas["azul"] = Fi_cap
        ...
        fondo = ImageTk.Image.open("img_marvel\\Marvel.gif")
        ...
        self.CAJA_ENTRADA = Entry(self.Panel, font='Helvetica 20', borderwidth=0)
        self.CAJA_ENTRADA.place(x=350, y=530, width=700, height=50)
        self.BTN_ENTRADA = Button(self.Panel, text='Continuar', font=("Times New Roman", 20), fg="white",
                                          command=self.continuar_juegos, bg="blue", borderwidth=0)
        self.BTN_ENTRADA.place(x=100, y=530, width=150, height=50)
        # --------------------------------------------------------------------------------------------------------------------------------------------
        TABLEROM = Tablero_Marvel()
        tablero1 = Tablero_Marvel.crearTablero(TABLEROM, self.LABEL_TABLEO)
        ...
        while not movimiento.GameOver(Jugadores):
            ...
            messagebox.showinfo("TIRAR DADOS",
                                "Turno de " + jugadorActual.nombre + ". presione ENTER para tirar los dados")
